...
function Splitter (params) {
    ...
    var me = this;
    crudlayout.util.addEventListener(params.container, "mousedown", function (event) {
...
Splitter.prototype.onMouseDown = function (event) {
    ...
    if (!this.params.mousedown) {
        ...
        this.params.mousemove =
            crudlayout.util.addEventListener(document, 'mousemove', function (event) {
                me.onMouseMove(event);
            });
        this.params.mouseup =
            crudlayout.util.addEventListener(document, 'mouseup', function (event) {
                me.onMouseUp(event);
            });
...
Splitter.prototype.onMouseUp = function (event) {
    if (this.params.mousedown) {
        crudlayout.util.removeEventListener(document, 'mousemove', this.params.mousemove);
        crudlayout.util.removeEventListener(document, 'mouseup', this.params.mouseup);
