 ...
 */
@Immutable
public class CrudzillaBasicResponseHandler implements ResponseHandler<Object> {
    ...
    public Object handleResponse(final HttpResponse response)
        ...
        java.util.Map resp = new java.util.HashMap();
        ...
        resp.put("response",entity == null ? "" : EntityUtils.toString(entity));
